	...
	displayProducts(products){
		...
		products.forEach(product=>{
			...
			productDiv.innerHTML = `<div class = "product-card">
									...
									<i class = "fa fa-cart--plus fa-1x" style = "margin-right:0.1em; font-size: 1em;">
									</i>Add to Cart</span>
...
cartContent.addEventListener("click", (event)=>{
	if(event.target.classList.contains("cart-product-remove")){
		...
		div.removeChild(event.target.event.target.parentElement.parentElement.parentElement.parentElement)
	}
